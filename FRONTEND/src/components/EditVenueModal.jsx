...
export default function EditVenueModal({ isOpen, onClose, venueData, fetchVenues }) {
    ...
    const handleSubmit = async () => {
        ...
        try {    
            ...
            if (newUploads.length > 0) { 
                ...
                await apiService.postVenuePhotos(formData, venueData?.id);
            ...
            <div className="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] shadow-xl flex flex-col overflow-hidden transform transition-all scale-100">
                {isLoading && (
                    <div className="absolute inset-0 z-50 flex items-center justify-center bg-white/70 backdrop-blur-sm">
                        <Loading LoadingText="Updating your Venue, Please wait." />
                    </div>
                )}
