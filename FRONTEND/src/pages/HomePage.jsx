...
function HeroContent() {
    return (
        <div className="Hero-Content text-center text-[#2a5660] px-4 md:px-8">
...
function Searchbar() {
    return (
        <div className="SEARCH-BAR flex w-[92%] md:w-full max-w-2xl mx-auto mt-4 md:mt-6">
            <input 
                type="text" 
                placeholder="Search for venues and Venue Types..." 
                className="w-full h-12 md:h-16 shadow-xl md:text-center text-sm md:text-lg px-3 md:px-4 rounded-l-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#AEAC9B] focus:border-transparent" 
            />
            <button 
