...
import { createVenue, uploadImage } from '../services/venueApi';

const CreateVenuePage = ({ showToast, loadVenues }) => {
  const navigate = useNavigate();
  const [formData, setFormData] = useState({ name: '', location: '', capacity: '', price_per_hour: '', photo_urls: [], inventory_type: 'capacity_based', features: {} });
    ...
    <div className="max-w-3xl mx-auto py-10 px-4">
      <div className="bg-slate-900 rounded-2xl shadow-xl overflow-hidden animate-[slide-up_0.3s_ease-out] border border-slate-800">
        <div className="bg-gradient-to-r from-slate-900 to-slate-800 border-b border-slate-800 px-8 py-6 flex justify-between items-center">
          <h2 className="text-2xl font-bold text-slate-100">Add New Venue</h2>
