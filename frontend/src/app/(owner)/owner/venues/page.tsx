                  ...
                  <div className="flex items-center justify-between gap-4 mt-6 pt-2">
                    ...
                    <div className="flex items-center gap-2">
                      <Link
                        ...
                        className="px-3.5 py-2.5 rounded-xl border border-slate-200 text-xs font-bold text-slate-600 bg-slate-50 hover:bg-slate-100 transition-colors"
                      >
                        Bookings
                      </Link>
                    </div>
      ...
      <footer className="bg-white border-t border-slate-200 mt-16 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-500">
            BookMyVenue. All rights reserved. Owner Portal.
          </p>
        </div>
      </footer>
    </div>
