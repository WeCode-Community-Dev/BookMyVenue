...
const { data: venueAvailabilityData } = useGetVenueAvailabilityQuery({ venueId, month })
  ...
  const getPricingRow = (dayType) =>
    pricingMap[dayType] ||
    pricingRows[0] || { price: 0, minHours: venue?.minBookingHours || 1 };

  const minBookingHours =
    venue?.minBookingHours ?? getPricingRow("weekday")?.minHours ?? 1;
  ...
  const handleBookNow = async () => {
    ...
    const requestBody = {
      ...
      startTime:
        bookingType === "hourly" ? startTime : venue.openTime || "00:00",
    ...
    try {
      ...
      setBookingMessage(
        "Booking request sent. Please complete the payment if redirected.",
      );
    } catch (err) {
      setBookingMessage(
        err?.data?.message ||
  ...
  const bookingLabel =
    bookingType === "hourly" ? "Hourly booking" : "Daily booking";
      ...
      <section className="venue-gallery">
        ...
        >
          ...
          >
            ...
            />
            <div className="venue-gallery__overlay">
              <FiMaximize2 />
            </div>
          </div>
          ...
          {images.slice(1, 5).map((img, index) => (
            ...
            >
              ...
              {index === 3 && images.length > 5 && (
                <div className="venue-gallery__more">
          ...
          <div className="lightbox__inner" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="lightbox__stage">
              ...
              <img
                ...
                alt={imageAlt(images[lightboxIndex] || {})}
              />
        ...
        <div className="venue-stats-bar__inner">
          ...
          <div className="venue-stat">
            ...
            <div>
              ...
              <span className="venue-stat__value">
            ...
            <div className="venue-stat venue-stat--price">
              <div>
                ...
                <span className="venue-stat__value">
                  ...
                  <small>/{bookingType === "hourly" ? "hr" : "day"}</small>
                </span>
              </div>
            </div>
          )}
          ...
          <div className="detail-card detail-card--compact">
            ...
            <div className="day-pills">
              {DAY_ORDER.map((day) => (
                <div
                  key={day}
                  className={`day-pill ${openDaysSet.has(day) ? "active" : ""}`}
                  title={day}
                >
            ...
            <div className="info-row">
              ...
              <div className="info-block">
                ...
                <span className="info-value">
                  {minBookingHours} {minBookingHours === 1 ? "hr" : "hrs"}
                </span>
              </div>
            </div>
          </div>
