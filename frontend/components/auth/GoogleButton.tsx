...
export default function GoogleButton({ onClick }: GoogleButtonProps) {
  return (
    <Button
      ...
      variant="outline"
      onClick={onClick}
      className="w-full rounded-xl border-slate-200 hover:border-slate-300 text-slate-700 bg-white font-semibold shadow-xs hover:bg-slate-50 cursor-pointer h-10 px-4 transition-all duration-150 flex items-center justify-center gap-2"
    >
