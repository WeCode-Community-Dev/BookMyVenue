...
export const seedPayments = async () => {
  ...
  const paymentsData = [
    // 1. Payment for Booking 1 (Completed)
    {
      ...
      amount: '70000.00',
      status: 'completed',
      phonePeOrderId: 'order_ballroom_001',
      phonePeTransactionId: 'pay_ballroom_001',
      phonePeTransactionRef: 'sig_ballroom_001_abc123xyz',
    ...
    // 2. Payment for Booking 2 (Pending)
    {
      ...
      amount: '3600.00',
      status: 'pending',
      phonePeOrderId: 'order_tech_001',
      phonePeTransactionId: null,
      phonePeTransactionRef: null,
      paidAt: null,
    },
    // 3. Payment for Booking 3 (Failed)
    {
      ...
      amount: '40000.00',
      status: 'failed',
      phonePeOrderId: 'order_bistro_001',
      phonePeTransactionId: 'pay_bistro_001_failed',
      phonePeTransactionRef: null,
      paidAt: null,
    },
    ...
    // 5. Payment for Booking 5 (Completed)
    {
      ...
      amount: '35000.00',
      status: 'completed',
      phonePeOrderId: 'order_ballroom_002',
      phonePeTransactionId: 'pay_ballroom_002',
      phonePeTransactionRef: 'sig_ballroom_002_def456uvw',
    ...
    // 6. Payment for Booking 6 (Completed)
    {
      ...
      amount: '1200.00',
      status: 'completed',
      phonePeOrderId: 'order_cozy_002',
      phonePeTransactionId: 'pay_cozy_002',
      phonePeTransactionRef: 'sig_cozy_002_ghi789rst',
    ...
    // 7. Payment for Booking 7 (Completed)
    {
      ...
      amount: '1800.00',
      status: 'completed',
      phonePeOrderId: 'order_tech_002',
      phonePeTransactionId: 'pay_tech_002',
      phonePeTransactionRef: 'sig_tech_002_jkl012opq',
