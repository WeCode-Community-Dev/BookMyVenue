...
export interface Venue {
  ...
  status: VerificationStatus; submitted: string; rating: number; bookings: number;
  image: string;
}
...
export const VENUES: Venue[] = [
  { id: "V001", name: "The Grand Pavilion", owner: "Suresh Nair", location: "Thrissur", category: "Wedding", capacity: 800, price: 28000, status: VerificationStatus.APPROVED, submitted: "2024-05-10", rating: 4.8, bookings: 34, image: "https://images.unsplash.com/photo-1717680281618-442cb9c12b6c?w=60&h=60&fit=crop&auto=format" },
  { id: "V002", name: "Lakeview Conference Centre", owner: "Priya Menon", location: "Ernakulam", category: "Conference", capacity: 350, price: 15000, status: VerificationStatus.APPROVED, submitted: "2024-05-14", rating: 4.6, bookings: 21, image: "https://images.unsplash.com/photo-1780337092608-aad7948d7a60?w=60&h=60&fit=crop&auto=format" },
  { id: "V003", name: "Emerald Garden", owner: "Rajan Pillai", location: "Kozhikode", category: "Wedding", capacity: 700, price: 32000, status: VerificationStatus.PENDING, submitted: "2024-07-01", rating: 0, bookings: 0, image: "https://images.unsplash.com/photo-1779308936221-89739e035a53?w=60&h=60&fit=crop&auto=format" },
  { id: "V004", name: "Royal Mahal Banquets", owner: "Anil Kumar", location: "Palakkad", category: "Wedding", capacity: 1200, price: 45000, status: VerificationStatus.PENDING, submitted: "2024-07-03", rating: 0, bookings: 0, image: "https://images.unsplash.com/photo-1763553113332-800519753e40?w=60&h=60&fit=crop&auto=format" },
  { id: "V005", name: "Chandrabhavan Palace", owner: "Sreeja Nambiar", location: "Thrissur", category: "Wedding", capacity: 1000, price: 40000, status: VerificationStatus.APPROVED, submitted: "2024-04-20", rating: 4.9, bookings: 48, image: "https://images.unsplash.com/photo-1768851142332-75f3d1b47452?w=60&h=60&fit=crop&auto=format" },
  { id: "V006", name: "Seaview Party Lawn", owner: "Biju Thomas", location: "Alappuzha", category: "Party", capacity: 400, price: 18000, status: VerificationStatus.REJECTED, submitted: "2024-06-12", rating: 0, bookings: 0, image: "https://images.unsplash.com/photo-1780682571078-242672d1dd59?w=60&h=60&fit=crop&auto=format" },
  { id: "V007", name: "Prestige Business Hub", owner: "Deepa Krishnan", location: "Ernakulam", category: "Corporate", capacity: 150, price: 20000, status: VerificationStatus.APPROVED, submitted: "2024-03-05", rating: 3.8, bookings: 9, image: "https://images.unsplash.com/photo-1768508951405-10e83c4a2872?w=60&h=60&fit=crop&auto=format" },
];
