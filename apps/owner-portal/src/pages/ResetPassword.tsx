...
export default function ResetPassword() {
  ...
  useEffect(() => {
    // Supabase's client detects the recovery token in the URL and establishes
    // a session automatically (detectSessionInUrl); PASSWORD_RECOVERY fires
    // once that happens, but the session may already be there by the time we mount.
  ...
  if (checkingSession) return <LoadingScreen message="Verifying your reset link…" />
    ...
    <AuthLayout
      left={
        <AuthCard
          ...
          subtitle="Choose a new password for your Venue404 owner account."
        >
          <div className="mb-7">
            <Logo />
          </div>
          ...
          {!hasSession ? (
            ...
            >
              <span>
                ...
                <a href="/forgot-password" className="font-medium underline">forgot password</a> page.
              </span>
            </div>
          ) : (
