...
import {
  ...
  CalendarDays, ClipboardList, Settings, Sparkles, LayoutGrid, Search, PhoneCall, Star,
  IndianRupee,
} from 'lucide-react'
...
const NAV: NavItemConfig[] = [
  ...
  { label: 'Financials',      href: '/financials',     icon: <IndianRupee className="h-4 w-4" /> },
  { label: 'External Reservations', href: '/external-reservations', icon: <PhoneCall className="h-4 w-4" /> },
