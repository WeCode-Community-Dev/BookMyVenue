...
export default function Sidebar() {
  return (
    <aside className="sticky top-[72px] hidden h-[calc(100vh-72px)] w-[240px] flex-col border-r border-slate-200 bg-white md:flex">
      ...
      <div className="border-t border-slate-200 p-4">
        <button className="flex w-full items-center justify-center gap-2 rounded-xl border border-slate-200 px-4 py-3 text-sm font-medium text-slate-600 transition hover:bg-slate-50">
...
// export default function Sidebar() {
//   return (
//     <aside className="sticky top-[72px] hidden h-[calc(100vh-72px)] w-[240px] border-r border-slate-200 bg-white md:flex flex-col">
...
//       <div className="border-t border-slate-200 p-4">
//         <button className="flex w-full items-center justify-center gap-2 rounded-xl border border-slate-200 px-4 py-3 text-sm font-medium text-slate-600 hover:bg-slate-50">
//           <ChevronLeft className="h-4 w-4" />
//           Collapse Sidebar
//         </button>
//       </div>
