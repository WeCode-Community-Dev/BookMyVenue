      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 py-10">
        ...
        {isLoading ? (
          <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {[1, 2, 3, 4].map((n) => (
              <div key={n} className="overflow-hidden rounded-2xl bg-white shadow-[0_1px_4px_rgba(0,0,0,0.08)] animate-pulse">
          ...
          <div className="mt-16 flex flex-col items-center justify-center text-center">
            ...
            <h2 className="text-xl font-semibold text-zinc-900">No saved venues yet</h2>
            <p className="mt-2 text-zinc-500 max-w-sm">
              As you search, click the heart icon to save your favorite venues here.
            </p>
            <Link
              to="/venues"
              className="mt-6 inline-flex h-10 items-center justify-center rounded-lg bg-zinc-900 px-6 font-medium text-white transition-colors hover:bg-zinc-800"
            >
              Start exploring
            </Link>
          </div>
