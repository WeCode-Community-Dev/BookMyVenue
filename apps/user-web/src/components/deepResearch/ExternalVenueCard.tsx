    ...
    <>
      <article className="group cursor-pointer overflow-hidden focus:outline-none focus-visible:ring-2 focus-visible:ring-brand/50 rounded-2xl">
        ...
        <div className="relative aspect-[8/5] overflow-hidden rounded-2xl bg-zinc-100 dark:bg-ink-800">
          {lead.cover_photo_url ? (
            ...
            <div className="flex h-full w-full flex-col items-center justify-center gap-3 bg-gradient-to-br from-zinc-100 to-zinc-50 dark:from-ink-800 dark:to-ink-900">
        ...
        <div className="py-3 px-1">
          ...
          <div className="mt-3">
            {status === 'requested' ? (
              ...
              <button
                ...
                className="w-full rounded-xl bg-zinc-900 px-4 py-2 text-sm font-bold text-white transition-all hover:bg-zinc-800 disabled:opacity-50 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-300"
              >
                Request Reservation
              </button>
            )}
          ...
          <div className="mt-3 flex items-start gap-2 rounded-lg bg-emerald-50/70 p-2.5 text-emerald-800 dark:bg-emerald-950/30 dark:text-emerald-300">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-zinc-900/40 backdrop-blur-sm" onClick={(e) => e.stopPropagation()}>
          <div className="w-full max-w-md rounded-3xl bg-white dark:bg-ink-900 p-6 shadow-2xl overflow-hidden" onClick={(e) => e.stopPropagation()}>
            <div className="mb-6">
            ...
            <form onSubmit={handleReserve} className="space-y-4">
              ...
              <div className="mt-6 flex gap-3 pt-2">
                <button
                  ...
                  className="flex-1 rounded-xl bg-zinc-100 py-3 text-sm font-semibold text-zinc-900 transition-colors hover:bg-zinc-200 dark:bg-ink-800 dark:text-zinc-100 dark:hover:bg-ink-700"
                >
                  Cancel
                </button>
                <button
