    ...
    <div className="min-h-screen bg-bg-primary pt-28 pb-16">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="text-center max-w-2xl mx-auto mt-16 mb-20">
          <span className="px-3.5 py-1 text-xs font-semibold tracking-wider rounded-full bg-primary/10 text-primary-light border border-primary/20 mb-6 inline-block">
          ...
          <p className="text-base sm:text-lg text-zinc-400 mb-8 max-w-xl mx-auto font-normal leading-relaxed">
          ...
          {/* Clean Flat Matte Search Bar */}
          <form onSubmit={handleSearch} className="bg-bg-card p-2 rounded-xl border border-white/8 flex flex-col sm:flex-row gap-2 shadow-xl">
            <div className="flex-1 relative flex items-center">
              <MdSearch className="absolute left-4 text-xl text-zinc-400" />
              <input
                type="text"
                className="w-full bg-transparent py-3 pl-12 pr-4 text-white placeholder-zinc-500 text-sm focus:outline-none"
            ...
            <button
              type="submit"
              className="py-3 px-6 font-bold rounded-lg bg-primary hover:bg-primary-dark text-white text-sm transition-all duration-200"
            >
              Search
            </button>
          </form>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24">
          <div className="matte-card p-8">
            <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center text-primary-light text-xl mb-6">
              <MdLocationOn />
            </div>
            <h3 className="text-lg font-bold text-white mb-3">Nearby Discovery</h3>
          ...
          <div className="matte-card p-8">
            ...
            <h3 className="text-lg font-bold text-white mb-3">Conflict Prevention</h3>
            <p className="text-zinc-400 text-sm leading-relaxed">
          ...
          <div className="matte-card p-8">
            ...
            <h3 className="text-lg font-bold text-white mb-3">Curated Spaces</h3>
            <p className="text-zinc-400 text-sm leading-relaxed">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {categories.map((cat, idx) => (
              ...
              >
                ...
                <span className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider">{cat.count}</span>
              </Link>
            ))}
          </div>
        </div>
        ...
        <div className="matte-card p-10 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="max-w-xl text-center md:text-left">
            <h2 className="text-2xl font-bold tracking-tight text-white mb-2">Own a venue or event space?</h2>
            <p className="text-zinc-400 text-sm leading-relaxed">
          ...
          <Link to="/register?role=venue_owner" className="py-3 px-6 whitespace-nowrap font-bold rounded-lg bg-primary hover:bg-primary-dark text-white text-sm transition-all">
            Start Hosting Today
          </Link>
        </div>
      </div>
