    ...
    <div className="bg-slate-50 border border-slate-205 shadow-lg rounded-3xl p-5 sm:p-6 space-y-6 text-left">
      <div className="space-y-2 border-b border-slate-200/80 pb-4">
        ...
        <p className="text-[11px] text-slate-500 font-semibold leading-relaxed">
          Manage approval rules, blocked dates, and guest booking requests for this venue.
        </p>
      </div>
      ...
      <form onSubmit={handleBlockDates} className="rounded-2xl border border-slate-200 bg-white p-4 space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <input type="date" value={blockStartDate} min="2026-07-22" onChange={(e) => setBlockStartDate(e.target.value)} className="h-10 rounded-xl border border-slate-200 px-3 text-sm font-semibold text-slate-800" required />
          <input type="date" value={blockEndDate} min={blockStartDate || "2026-07-22"} onChange={(e) => setBlockEndDate(e.target.value)} className="h-10 rounded-xl border border-slate-200 px-3 text-sm font-semibold text-slate-800" required />
        </div>
