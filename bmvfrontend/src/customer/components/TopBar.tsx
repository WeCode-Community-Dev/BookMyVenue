...
export function CustomerTopBar({ customerName, onMobileMenuOpen, className }: TopBarProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 shrink-0">
        {/* Quick link to main search page */}
        <Link href="/venues" className="hidden sm:flex items-center gap-1 text-xs font-semibold text-[#0D7377] hover:underline px-3 py-1.5 rounded-lg bg-[#E6F1F1] transition-all">
