...
as UserVenueLocationModel,minCapacity: null == minCapacity ? _self.minCapacity : minCapacity // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'owner_id')  String ownerId, @JsonKey(name: 'venue_name')  String venueName,  String slug,  String category,  String description,  UserVenueLocationModel location, @JsonKey(name: 'min_capacity')  int minCapacity, @JsonKey(name: 'max_capacity')  int maxCapacity,  List<UserVenueAmenityModel> amenities, @JsonKey(name: 'cover_image_url')  String coverImageUrl, @JsonKey(name: 'gallery_images')  List<UserVenueGalleryImageModel> galleryImages, @JsonKey(name: 'virtual_tour_url')  String? virtualTourUrl,  List<UserVenueSlotModel> slots,  List<UserVenueServiceModel> services, @JsonKey(name: 'instant_booking')  bool instantBooking,  String status, @JsonKey(name: 'average_rating')  double averageRating, @JsonKey(name: 'total_reviews')  int totalReviews, @JsonKey(name: 'view_count')  int viewCount, @JsonKey(name: 'booking_count')  int bookingCount, @JsonKey(name: 'is_featured')  bool isFeatured, @JsonKey(name: 'verification_status')  String verificationStatus, @JsonKey(name: 'approved_by')  String? approvedBy, @JsonKey(name: 'approved_at')  DateTime? approvedAt, @JsonKey(name: 'rejection_reason')  String? rejectionReason, @JsonKey(name: 'published_at')  DateTime? publishedAt, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserVenueModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'owner_id')  String ownerId, @JsonKey(name: 'venue_name')  String venueName,  String slug,  String category,  String description,  UserVenueLocationModel location, @JsonKey(name: 'min_capacity')  int minCapacity, @JsonKey(name: 'max_capacity')  int maxCapacity,  List<UserVenueAmenityModel> amenities, @JsonKey(name: 'cover_image_url')  String coverImageUrl, @JsonKey(name: 'gallery_images')  List<UserVenueGalleryImageModel> galleryImages, @JsonKey(name: 'virtual_tour_url')  String? virtualTourUrl,  List<UserVenueSlotModel> slots,  List<UserVenueServiceModel> services, @JsonKey(name: 'instant_booking')  bool instantBooking,  String status, @JsonKey(name: 'average_rating')  double averageRating, @JsonKey(name: 'total_reviews')  int totalReviews, @JsonKey(name: 'view_count')  int viewCount, @JsonKey(name: 'booking_count')  int bookingCount, @JsonKey(name: 'is_featured')  bool isFeatured, @JsonKey(name: 'verification_status')  String verificationStatus, @JsonKey(name: 'approved_by')  String? approvedBy, @JsonKey(name: 'approved_at')  DateTime? approvedAt, @JsonKey(name: 'rejection_reason')  String? rejectionReason, @JsonKey(name: 'published_at')  DateTime? publishedAt, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _UserVenueModel():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'owner_id')  String ownerId, @JsonKey(name: 'venue_name')  String venueName,  String slug,  String category,  String description,  UserVenueLocationModel location, @JsonKey(name: 'min_capacity')  int minCapacity, @JsonKey(name: 'max_capacity')  int maxCapacity,  List<UserVenueAmenityModel> amenities, @JsonKey(name: 'cover_image_url')  String coverImageUrl, @JsonKey(name: 'gallery_images')  List<UserVenueGalleryImageModel> galleryImages, @JsonKey(name: 'virtual_tour_url')  String? virtualTourUrl,  List<UserVenueSlotModel> slots,  List<UserVenueServiceModel> services, @JsonKey(name: 'instant_booking')  bool instantBooking,  String status, @JsonKey(name: 'average_rating')  double averageRating, @JsonKey(name: 'total_reviews')  int totalReviews, @JsonKey(name: 'view_count')  int viewCount, @JsonKey(name: 'booking_count')  int bookingCount, @JsonKey(name: 'is_featured')  bool isFeatured, @JsonKey(name: 'verification_status')  String verificationStatus, @JsonKey(name: 'approved_by')  String? approvedBy, @JsonKey(name: 'approved_at')  DateTime? approvedAt, @JsonKey(name: 'rejection_reason')  String? rejectionReason, @JsonKey(name: 'published_at')  DateTime? publishedAt, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _UserVenueModel() when $default != null:
return $default(_that.id,_that.ownerId,_that.venueName,_that.slug,_that.category,_that.description,_that.location,_that.minCapacity,_that.maxCapacity,_that.amenities,_that.coverImageUrl,_that.galleryImages,_that.virtualTourUrl,_that.slots,_that.services,_that.instantBooking,_that.status,_that.averageRating,_that.totalReviews,_that.viewCount,_that.bookingCount,_that.isFeatured,_that.verificationStatus,_that.approvedBy,_that.approvedAt,_that.rejectionReason,_that.publishedAt,_that.createdAt,_that.updatedAt);case _:
  return null;
