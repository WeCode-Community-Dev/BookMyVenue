...
import { 
  ...
  Bell, Settings as SettingsIcon, Image, Menu, X, ChevronDown, ChevronRight,
...
function AppContent() {
  ...
  return (
    <div className="min-h-screen bg-bg-dark text-slate-100 flex flex-col font-sans">
      ...
      {/* HEADER NAVBAR */}
      <header className="h-16 glass-panel border-b border-slate-900 px-4 flex justify-between items-center sticky top-0 z-40">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 cursor-pointer" onClick={() => handleNav('dashboard')}>
            <div className="w-8 h-8 rounded-lg bg-gradient-to-r from-primary to-accent flex justify-center items-center font-black text-slate-950 text-sm shadow-md">
              BMV
            </div>
        ...
        <div className="flex items-center gap-4 relative">
          ...
          <div className="relative">
            <button 
              ...
              className="p-2 rounded-lg bg-slate-900 border border-slate-800 text-slate-400 hover:text-white transition relative"
            >
            ...
            {notificationPopoverOpen && (
              <div className="absolute right-0 mt-2 w-80 glass-panel border border-slate-800 rounded-xl p-4 shadow-xl space-y-3 z-50">
                <div className="flex justify-between items-center border-b border-slate-900 pb-2">
                  <span className="font-bold text-white text-xs">Recent Activities</span>
                  <button 
                ...
                <div className="space-y-2 max-h-[200px] overflow-y-auto pr-1">
                  {notifications.slice(0, 4).map(notif => (
                    <div key={notif.id} className="p-2 bg-slate-950/40 border border-slate-900 rounded text-xs space-y-1">
          ...
          <div className="flex items-center gap-2.5 pl-3 border-l border-slate-900">
            ...
            <div className="hidden md:block text-left">
              <span className="text-xs font-bold text-white block">Jiyad Ahammad</span>
      ...
      <div className="flex-1 flex relative">
        ...
        <aside className="w-64 bg-slate-950/50 border-r border-slate-900 flex-col py-4 px-3 sticky top-16 h-[calc(100vh-64px)] overflow-y-auto hidden md:flex space-y-6">
          ...
          <div className="space-y-1.5">
            ...
            <button
              ...
              className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-semibold transition ${
                currentSection === 'dashboard' ? 'bg-primary text-white shadow-md' : 'text-slate-400 hover:text-white hover:bg-slate-900/40'
              }`}
            >
          ...
          <div className="space-y-1">
            <button
              ...
              className="w-full flex items-center justify-between px-3 text-slate-500 hover:text-white transition py-1 text-left"
            >
            ...
            {usersExpanded && (
              <div className="space-y-0.5 pl-2 pt-1">
                <button
                  ...
                  className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-semibold transition ${
                    currentSection === 'users-customers' ? 'bg-primary/20 text-white border-l-2 border-primary' : 'text-slate-400 hover:text-white hover:bg-slate-900/30'
                  }`}
                >
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-semibold transition ${
                    currentSection === 'users-owners' ? 'bg-primary/20 text-white border-l-2 border-primary' : 'text-slate-400 hover:text-white hover:bg-slate-900/30'
                  }`}
                >
                  <UsersIcon className="w-3.5 h-3.5" />
            ...
            {venuesExpanded && (
              <div className="space-y-0.5 pl-2 pt-1">
                <button
                  ...
                  className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-semibold transition ${
                    currentSection === 'venues-all' ? 'bg-primary/20 text-white border-l-2 border-primary' : 'text-slate-400 hover:text-white hover:bg-slate-900/30'
                  }`}
                >
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-between px-3 py-2 rounded-lg text-xs font-semibold transition ${
                    currentSection === 'venues-pending' ? 'bg-primary/20 text-white border-l-2 border-primary' : 'text-slate-400 hover:text-white hover:bg-slate-900/30'
                  }`}
                >
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-semibold transition ${
                    currentSection === 'venues-blocked' ? 'bg-primary/20 text-white border-l-2 border-primary' : 'text-slate-400 hover:text-white hover:bg-slate-900/30'
                  }`}
                >
            ...
            {bookingsExpanded && (
              <div className="space-y-0.5 pl-2 pt-1">
                <button
                  ...
                  className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-semibold transition ${
                    currentSection === 'bookings-all' ? 'bg-primary/20 text-white border-l-2 border-primary' : 'text-slate-400 hover:text-white hover:bg-slate-900/30'
                  }`}
                >
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-semibold transition ${
                    currentSection === 'bookings-upcoming' ? 'bg-primary/20 text-white border-l-2 border-primary' : 'text-slate-400 hover:text-white hover:bg-slate-900/30'
                  }`}
                >
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-semibold transition ${
                    currentSection === 'bookings-completed' ? 'bg-primary/20 text-white border-l-2 border-primary' : 'text-slate-400 hover:text-white hover:bg-slate-900/30'
                  }`}
                >
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-semibold transition ${
                    currentSection === 'bookings-cancelled' ? 'bg-primary/20 text-white border-l-2 border-primary' : 'text-slate-400 hover:text-white hover:bg-slate-900/30'
                  }`}
                >
            ...
            {paymentsExpanded && (
              <div className="space-y-0.5 pl-2 pt-1">
                <button
                  ...
                  className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-semibold transition ${
                    currentSection.startsWith('payments') ? 'bg-primary/20 text-white border-l-2 border-primary' : 'text-slate-400 hover:text-white hover:bg-slate-900/30'
                  }`}
                >
          ...
          <div className="space-y-1.5 pt-2 border-t border-slate-900">
            ...
            <button
              ...
              className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-semibold transition ${
                currentSection === 'reports' ? 'bg-primary text-white shadow-md' : 'text-slate-400 hover:text-white hover:bg-slate-900/40'
              }`}
            >
            ...
            <button
              onClick={() => handleNav('notifications')}
              className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-semibold transition ${
                currentSection === 'notifications' ? 'bg-primary text-white shadow-md' : 'text-slate-400 hover:text-white hover:bg-slate-900/40'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-semibold transition ${
                currentSection === 'cms' ? 'bg-primary text-white shadow-md' : 'text-slate-400 hover:text-white hover:bg-slate-900/40'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-semibold transition ${
                currentSection === 'settings' ? 'bg-primary text-white shadow-md' : 'text-slate-400 hover:text-white hover:bg-slate-900/40'
              }`}
            >
        ...
        {mobileMenuOpen && (
          <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm md:hidden flex">
            <aside className="w-72 bg-slate-950 p-6 flex flex-col h-full space-y-6 relative border-r border-slate-900">
              
              <button 
                onClick={() => setMobileMenuOpen(false)}
                className="absolute top-4 right-4 text-slate-500 hover:text-white p-1 hover:bg-slate-900 rounded-full transition"
              >
                <X className="w-5 h-5" />
              </button>

              <div className="flex items-center gap-2 pb-4 border-b border-slate-900">
                <div className="w-8 h-8 rounded-lg bg-gradient-to-r from-primary to-accent flex justify-center items-center font-black text-slate-950 text-xs">
                  BMV
                </div>
                <span className="font-extrabold text-white text-base">BookMyVenue</span>
              </div>
              ...
              <div className="space-y-4 overflow-y-auto flex-1 pr-2">
                ...
                <div className="space-y-1">
                  ...
                  <button onClick={() => handleNav('dashboard')} className="w-full text-left py-2 px-3 hover:bg-slate-900 rounded text-xs font-semibold text-slate-300">Dashboard</button>
                </div>

                <div className="space-y-1">
                  <span className="text-[8px] font-semibold text-slate-500 uppercase tracking-wider block mb-2">Users</span>
                  <button onClick={() => handleNav('users-customers')} className="w-full text-left py-2 px-3 hover:bg-slate-900 rounded text-xs font-semibold text-slate-300 pl-6">Customers</button>
                  <button onClick={() => handleNav('users-owners')} className="w-full text-left py-2 px-3 hover:bg-slate-900 rounded text-xs font-semibold text-slate-300 pl-6">Venue Owners</button>
                </div>

                <div className="space-y-1">
                  <span className="text-[8px] font-semibold text-slate-500 uppercase tracking-wider block mb-2">Venues</span>
                  <button onClick={() => handleNav('venues-all')} className="w-full text-left py-2 px-3 hover:bg-slate-900 rounded text-xs font-semibold text-slate-300 pl-6">All Spaces</button>
                  <button onClick={() => handleNav('venues-pending')} className="w-full text-left py-2 px-3 hover:bg-slate-900 rounded text-xs font-semibold text-slate-300 pl-6 flex justify-between">
                    <span>Pending approvals</span>
                  ...
                  <button onClick={() => handleNav('venues-blocked')} className="w-full text-left py-2 px-3 hover:bg-slate-900 rounded text-xs font-semibold text-slate-300 pl-6">Blocked Spaces</button>
                </div>

                <div className="space-y-1">
                  <span className="text-[8px] font-semibold text-slate-500 uppercase tracking-wider block mb-2">Bookings</span>
                  <button onClick={() => handleNav('bookings-all')} className="w-full text-left py-2 px-3 hover:bg-slate-900 rounded text-xs font-semibold text-slate-300 pl-6">All Bookings</button>
                  <button onClick={() => handleNav('bookings-upcoming')} className="w-full text-left py-2 px-3 hover:bg-slate-900 rounded text-xs font-semibold text-slate-300 pl-6">Upcoming</button>
                  <button onClick={() => handleNav('bookings-completed')} className="w-full text-left py-2 px-3 hover:bg-slate-900 rounded text-xs font-semibold text-slate-300 pl-6">Completed</button>
                  <button onClick={() => handleNav('bookings-cancelled')} className="w-full text-left py-2 px-3 hover:bg-slate-900 rounded text-xs font-semibold text-slate-300 pl-6">Cancelled</button>
                </div>
                ...
                <div className="space-y-1 pt-4 border-t border-slate-900">
                  ...
                  <button onClick={() => handleNav('reports')} className="w-full text-left py-2 px-3 hover:bg-slate-900 rounded text-xs font-semibold text-slate-300">Complaints dispute</button>
                  <button onClick={() => handleNav('notifications')} className="w-full text-left py-2 px-3 hover:bg-slate-900 rounded text-xs font-semibold text-slate-300">System Broadcasts</button>
                  <button onClick={() => handleNav('cms')} className="w-full text-left py-2 px-3 hover:bg-slate-900 rounded text-xs font-semibold text-slate-300">Marketing banners</button>
                  <button onClick={() => handleNav('settings')} className="w-full text-left py-2 px-3 hover:bg-slate-900 rounded text-xs font-semibold text-slate-300">Platform Settings</button>
                </div>
